...
class EditPatientScreen extends StatefulWidget {
  EditPatientScreen({Key key, @required this.curPatient}) : super(key: key);
...
class _EditPatientScreenState extends State<EditPatientScreen> {
  ...
  void initState() {
    ...
    setState(() {
      agentValue = widget.curPatient.agentName;
      diseaseValue = widget.curPatient.disease;
      riskValue = widget.curPatient.risk;
      newPatient = widget.curPatient;
    });

    if (widget.curPatient.image != 'bolo')
      setState(() {
        hasImage = true;
        fileActual = File(widget.curPatient.image);
      });
    agents.clear();
        ...
        child: ListView(
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                initialValue: widget.curPatient.name,
                validator: (name) {
                  if (name.isEmpty) {
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                initialValue: widget.curPatient.dateBirthday,
                validator: (birthday) {
            ...
            Padding(
              ...
              child: TextFormField(
                focusNode: myFocusNode2,
                initialValue: widget.curPatient.cpf,
                readOnly: true,
                validator: (cpf) {
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                initialValue: widget.curPatient.susCard,
                validator: (susCard) {
            ...
            Padding(
              ...
              child: TextFormField(
                focusNode: myFocusNode4,
                initialValue: widget.curPatient.motherName,
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                initialValue: widget.curPatient.extraInfo,
                validator: (extraInfo) {
